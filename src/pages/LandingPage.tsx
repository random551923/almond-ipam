        ...
        <div className="flex-1 flex flex-row items-center justify-center gap-10 ">
            <div className="flex flex-col gap-10 max-w-lg items-center text-primary-text">
                ...
                <div className="flex flex-row gap-4 w-full px-10">
                    <button className="flex-1 px-6 py-2.5 rounded-md whitespace-nowrap bg-container-bg-basic text-primary text-sm font-medium transition-transform hover:scale-105">
                        {"<- Get Started"}
                    </button>
                    <button className="px-6 py-2.5 rounded-md whitespace-nowrap text-primary-text border-primary-text border-2 text-sm font-medium transition-transform hover:scale-105">
                        Learn More
                    </button>
                </div>
            </div>
